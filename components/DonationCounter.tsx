...
export default function DonationCounter({ 
  ...
  return (
    <section className="relative pt-20 pb-16 sm:pt-24 sm:pb-20 md:pt-28 md:pb-24 lg:pt-32 lg:pb-28 overflow-hidden" style={{ marginTop: '80px' }}>
      {/* Background image */}
      ...
      <div className="container-custom relative z-10">
        <div className="text-center">
          ...
          <div className="mb-6 sm:mb-8 md:mb-10 mt-12 sm:mt-16 md:mt-20 relative inline-block">
