...
import Image from 'next/image'
  ...
  const steps = [
    ...
    },
    {
      ...
      title: 'Net Proceeds Donated',
    description:
      '100% of the net proceeds from shoe sales go directly to RMH CTMA, helping families stay close to their children during medical treatment.',
    },
  ]
  ...
  return (
    <section id="how-it-works" ref={ref} className="relative section-padding">
      ...
      <div className="container-custom relative z-10">
        ...
        >
          <h2 className="text-4xl sm:text-5xl md:text-6xl font-bold text-gray-900 mb-6">How It Works</h2>
